...
#define shell_error(shell, fmt, ...)   shell_printf(shell, FONT_COLO_RED fmt FONT_COLO_WHITE, ##__VA_ARGS__)
#define shell_success(shell, fmt, ...) shell_printf(shell, FONT_COLO_GREEN fmt FONT_COLO_WHITE, ##__VA_ARGS__)
#define shell_info(shell, fmt, ...)    shell_printf(shell, FONT_COLO_LIGHTBLUE fmt FONT_COLO_WHITE, ##__VA_ARGS__)
#define shell_warning(shell, fmt, ...) shell_printf(shell, FONT_COLO_YELLOW fmt FONT_COLO_WHITE, ##__VA_ARGS__)
